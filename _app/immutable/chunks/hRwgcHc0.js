import{t as m,a as s,n as b}from"./CEYJ1X-9.js";import"./DPOUz0k3.js";import{c as k,r as w,s as e,f as v,n as B}from"./C93sEKZr.js";import{h as i}from"./BQG484T6.js";import{a as _}from"./BHLCJ1HI.js";var C=m('<div class="scrollbox svelte-e7vp9s"><!></div>');function p(o,r){var t=C(),l=k(t);_(l,()=>r.children),w(t),s(o,t)}const u={date:"2025-06-24",tags:["Algorithms"],keywords:["Bloom filters","Probabilistic data structures","Counting Bloom filters"],title:"Grokking Bloom Filters: Counting Bloom Filter",preview:"Bloom filters can't remove elements — unless you let them count.",draft:!1,hero:"/images/blog/009-counting-bloom-filters/hero.jpg"},{date:Y,tags:P,keywords:X,title:M,preview:q,draft:O,hero:j}=u;var F=b(`<svg xmlns="http://www.w3.org/2000/svg" width="672" height="208" class="svgbob"><style>.svgbob line, .svgbob path, .svgbob circle, .svgbob rect, .svgbob polygon {
  stroke: black;
  stroke-width: 2;
  stroke-opacity: 1;
  fill-opacity: 1;
